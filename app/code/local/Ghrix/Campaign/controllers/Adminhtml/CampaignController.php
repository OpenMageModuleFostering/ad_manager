...
class Ghrix_Campaign_Adminhtml_CampaignController extends Mage_Adminhtml_Controller_Action
{
		...
		public function saveAction()
		{
			...
			$post_data=$this->getRequest()->getPost();
				...
				if ($post_data) {
					...
					$post_data['country']=implode(',',$post_data['country']);
				 //save image
		try{
		...
		if ($_FILES['photo']['name']) {
			...
			if($this->getRequest()->getParam("id")){
				...
				if($model->getData('photo')){
						...
						$post_data['photo']='campaign/campaign/'.$filename;
		}
    }
}
